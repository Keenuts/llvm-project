...
void clang::CodeGen::CGHLSLRuntime::setHLSLEntryNumThreadsAttribute(const HLSLNumThreadsAttr *attribute, llvm::Function *Fn) {
  ...
  std::string NumThreadsStr = formatv("{0},{1},{2}", attribute->getX(), attribute->getY(), attribute->getZ());
