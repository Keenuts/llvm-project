...
%Request = type { i32, <2 x i32>, i32 }
%ConstantBuffer = type opaque

@RWStrucutredBuffer.Request = external addrspace(2) constant %Request, align 4

; Function Attrs: norecurse
define void @main.1() #1 {
entry:
  %page_index_0 = getelementptr inbounds %Request, ptr addrspace(2) @RWStrucutredBuffer.Request, i32 0, i32 1
  %0 = load <2 x i32>, ptr addrspace(2) %page_index_0, align 4

  %page_index_1 = getelementptr inbounds %Request, ptr addrspace(2) @RWStrucutredBuffer.Request, i32 0, i32 1
  store <2 x i32> %0, ptr addrspace(2) %page_index_1, align 4
  ret void
}
